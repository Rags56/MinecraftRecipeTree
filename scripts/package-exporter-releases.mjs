...
export const EXPORTER_RELEASE_DEFINITIONS = Object.freeze([
  Object.freeze({
    ...
    source: 'recipe-export-mod-1.21.1/build/libs/jeiexport-1.21.1-neoforge-1.2.0-beta.2.jar',
    filename: 'recipe-tree-exporter-neoforge-1.21.1-1.2.0-beta.2.jar',
  ...
  Object.freeze({
    ...
    recipeViewer: 'JEI 15',
    loader: 'Forge 47',
    version: '1.2.0-beta.73',
    source: 'recipe-export-mod-1.20.1/build/libs/jeiexport-1.2.0-beta.73.jar',
    filename: 'recipe-tree-exporter-forge-1.20.1-1.2.0-beta.73.jar',
